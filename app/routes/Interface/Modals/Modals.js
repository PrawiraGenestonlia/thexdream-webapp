    ...
    <Container>
        ...
        <Row>
           { /* START Col6 1 */}
            <Col lg={ 6 }>
                { /* START Card Modal */}
                <Card className="mb-3 text-center" type="background" color="primary">
                    <CardBody>
                        <CardTitle tag="h6" className="mb-3">
                            Modal Alerts: Primary
                            <span className="small ml-1 text-white-06">
                                #4.01
                            </span>
                        </CardTitle>
                        <Button id="modalDefault401" color="white">
                            See Modal  <i className="fa fa-angle-right ml-1"></i>
                        </Button>
                        { /* START Example Modal */}
                        <UncontrolledModal target="modalDefault401" className="modal-primary">
                            ...
                            <ModalBody className="text-center px-5">
                                ...
                                <UncontrolledModal.Close color="white" className="mr-2">
                                    Save
                                </UncontrolledModal.Close>
                                <UncontrolledModal.Close color="link">
                                    Close
            ...
            <Col lg={ 6 }>
                { /* START Card Modal */}
                <Card className="mb-3 text-center" type="background" color="danger">
                    <CardBody>
                        <CardTitle tag="h6" className="mb-3">
                            Modal Alerts: Danger
                            <span className="small ml-1 text-white-06">
                        ...
                        <Button id="modalDefault402" color="white">
                            See Modal  <i className="fa fa-angle-right ml-1"></i>
                        </Button>
                        { /* START Example Modal */}
            ...
            <Col lg={ 6 }>
                { /* START Card Modal */}
                <Card className="mb-3 text-center" type="background" color="info">
                    <CardBody>
                        <CardTitle tag="h6" className="mb-3">
                            Modal Alerts: Info
                            <span className="small ml-1 text-white-06">
                        ...
                        <Button id="modalDefault403" color="white">
                            See Modal  <i className="fa fa-angle-right ml-1"></i>
                        </Button>
                        { /* START Example Modal */}
            ...
            <Col lg={ 6 }>
                { /* START Card Modal */}
                <Card className="mb-3 text-center"  type="background" color="warning">
                    <CardBody>
                        <CardTitle tag="h6" className="mb-3">
                        ...
                        <Button id="modalDefault404" color="white">
                            See Modal  <i className="fa fa-angle-right ml-1"></i>
                        </Button>
                        { /* START Example Modal */}
            ...
            <Col lg={ 6 }>
                { /* START Card Modal */}
                <Card className="mb-3 text-center" type="background" color="success">
                    <CardBody>
                        <CardTitle tag="h6" className="mb-3">
                        ...
                        <Button id="modalDefault405" color="white">
                            See Modal  <i className="fa fa-angle-right ml-1"></i>
                        </Button>
                        { /* START Example Modal */}
            ...
            <Col lg={ 6 }>
                { /* START Card Modal */}
                <Card className="mb-3 text-center" type="background" color="white">
                    <CardBody>
                        <CardTitle tag="h6" className="mb-3 text-dark">
